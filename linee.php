        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="linee.php" aria-current="page">Linee</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-lg-2 briciole">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Linee</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col col-md-8">
                <h1 class="colore-testo">Linee</h1>
            </div>
        </div>
        <div class="row justify-content-center mb-3">
            <div class="col col-md-8">
                <p class="colore-testo">
                    TBT offre dodici linee urbane tra tram e bus, che collegano centro e periferie della città di
                    Torino.
                    <br />
                    Di seguito elencate le nostre linee con le relative fermate:
                </p>
            </div>
        </div>
        <div class="row justify-content-center">
